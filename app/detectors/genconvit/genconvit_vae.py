...
class GenConViTVAE(nn.Module):
    ...
    Architecture: VAE encoder compresses the image to a latent space, decoder
    reconstructs it. ConvNeXt backbone (with Swin HybridEmbed) classifies both
    original and VAE-reconstructed images. Features concatenated for binary
    classification.
    """
    ...
    def __init__(self, config, pretrained=False):
        ...
        self.encoder = VariationalEncoder(self.latent_dims)
